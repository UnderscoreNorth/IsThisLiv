                ...
                <div class='bracketMatchContainer'>
                    {#if double['Grand Final'].matches.length == 2}
                        <div class='bracketGrandFinal'>
                            <div style:font-weight={double['Grand Final'].matches[1].home == double['Grand Final'].matches[1].winner ? 'bold' : 'normal'}>/{double['Grand Final'].matches[1].home}/</div>
                            <div style:font-weight={double['Grand Final'].matches[1].home == double['Grand Final'].matches[1].winner ? 'bold' : 'normal'}>{double['Grand Final'].matches[0].homeg}</div>
                            <div style:font-weight={double['Grand Final'].matches[1].home == double['Grand Final'].matches[1].winner ? 'bold' : 'normal'}>{double['Grand Final'].matches[1].homeg}</div>
                            <div style:font-weight={double['Grand Final'].matches[1].away == double['Grand Final'].matches[1].winner ? 'bold' : 'normal'}>/{double['Grand Final'].matches[1].away}/</div>
                            <div style:font-weight={double['Grand Final'].matches[1].away == double['Grand Final'].matches[1].winner ? 'bold' : 'normal'}>{double['Grand Final'].matches[0].awayg}</div>
                            <div style:font-weight={double['Grand Final'].matches[1].away == double['Grand Final'].matches[1].winner ? 'bold' : 'normal'}>{double['Grand Final'].matches[1].awayg}</div>
                        </div>
                    {:else}
                        <div class='bracketMatch'>
